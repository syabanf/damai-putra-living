...
const MOCK_DEALS = {
  ...
  3: { id: 3, title: 'Weekend Property Fair', date: '15 Mar 2026', tag: 'FAIR', img: 'https://images.unsplash.com/photo-1560184897-ae75f418493e?w=800&q=80', content: 'Main Community presents the Weekend Property Fair showcasing available units and investment opportunities. Meet with sales representatives, explore floor plans, and learn about financing options. Special promotions and flexible payment schemes available during the fair. Do not miss this opportunity!' },
};
