...
const faqs = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What types of permits are available?', a: 'Available permits include: Activity Permit, Minor & Major Renovation, Land Development, Excavation, Move-In / Move-Out, and Contractor Access.' },
  ...
  },
  {
    ...
    items: [
      { q: 'How do I update my profile information?', a: 'Profile information is managed through your account settings. Contact management if you need to update your registered email.' },
      ...
      { q: 'How do I enable notifications?', a: 'Go to Profile → Notifications to manage your notification preferences.' },
    ]
  },
];
...
function AccordionItem({ q, a }) {
  ...
  return (
    <div className="border-b last:border-0" style={{ borderColor: 'rgba(255,255,255,0.6)' }}>
